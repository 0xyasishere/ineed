  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      >
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`manga-outline-sm px-5 py-2.5 text-sm font-bold transition-all cursor-pointer ${
      ...
      >
        ...
        <div className="space-y-3">
          <button className="w-full manga-outline bg-muted/50 px-4 py-2.5 text-left text-sm font-semibold text-foreground/70 transition-colors hover:bg-muted cursor-pointer">
            Change Password
          </button>
          <button className="w-full manga-outline bg-muted/50 px-4 py-2.5 text-left text-sm font-semibold text-foreground/70 transition-colors hover:bg-muted cursor-pointer">
